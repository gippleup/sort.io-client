...
const IconContainer: React.FC<ContainerProps> = (props) => {
  const {size = 45, color = "black", border = "none", borderWidth = 2} = props;
  return (
    <View style={{
...
const getIcon = (targetSet: keyof typeof iconSet, iconName: string, option?: IconOption) => {
