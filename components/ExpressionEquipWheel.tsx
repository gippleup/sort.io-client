...
class ExpressionEquipWheel extends React.Component<ExpressionEquipWheelProps, {}> {
  size = 100;
  initialWidthConstant = 311.42857142857144;
  ratio = this.size / this.initialWidthConstant;
  marginFromBorder = 10;
  marginRatio = this.marginFromBorder / this.initialWidthConstant;
  adjustedMargin = this.size * this.marginRatio;
  iconScale = 1.2 * this.ratio;
  iconPadding = 3;
  iconPaddingColor = 'rgba(0,0,0,0.2)';
      ...
      >
          ...
          children={(
            <View
              style={{
                ...
                scaleY: iconScale,
                padding: iconPadding,
                backgroundColor: iconPaddingColor,
                borderRadius: 100
              }}
            >
              {left ? expressions[left](true) : <></>}
            </View>
          )}
        />
        <View
        ...
        <View
          ...
          children={(
            ...
            >
              {bottom ? expressions[bottom](true) : <></>}
            </View>
          )}
        />
        <View
          ...
          children={(
            <View
              style={{
                scaleX: iconScale * 1.2,
                scaleY: iconScale * 1.2,
                padding: iconPadding,
                backgroundColor: iconPaddingColor,
                borderRadius: 100
              }}
            >
              {center ? expressions[center](true) : <></>}
            </View>
          )}
        />
        <G
