...
import {
  BlockBoardContainer,
  GameInfoContainer,
  GameSceneContainer as FastGameSceneContainer,
  LevelInfo,
  LevelInfoContainer,
  MetaInfoContainer,
  OpponentBoard,
...
class FastGameScene extends React.Component<FastGameSceneProps, {}>{
  ...
  constructor(props: Readonly<FastGameSceneProps>) {
    super(props);
